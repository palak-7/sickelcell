      ...
      <div>
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            value="Subscribe"
            className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-primary/90 hover:bg-blue-500"
          >
            Subscribe
          </button>
        </form>
